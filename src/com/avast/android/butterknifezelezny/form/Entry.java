...
//ui
    ...
    protected JCheckBox mEventText;
    protected JCheckBox mEventColor;
    protected JCheckBox mEventGone;
    protected JCheckBox mEventBackground;
    ...
    public Entry(EntryList parent, Element element, ArrayList<String> ids) {
        ...
        //settext
        mEventText = new JCheckBox();
        mEventText.setPreferredSize(new Dimension(100, 26));
        //settextcolor
        mEventColor = new JCheckBox();
        mEventColor.setPreferredSize(new Dimension(100, 26));
        //setgone
        mEventGone = new JCheckBox();
        mEventGone.setPreferredSize(new Dimension(100, 26));
        //setbackground
        mEventBackground = new JCheckBox();
        mEventBackground.setPreferredSize(new Dimension(100, 26));
        ...
        mName.setPreferredSize(new Dimension(100, 36));
    ...
    public Element syncElement() {
        ...
        mElement.isClickText = mEventText.isSelected();
        mElement.isClickTextColor = mEventColor.isSelected();
        mElement.isClickGone = mEventGone.isSelected();
        mElement.isClickBackGround = mEventBackground.isSelected();
