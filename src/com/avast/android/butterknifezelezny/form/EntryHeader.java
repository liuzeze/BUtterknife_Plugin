...
public class EntryHeader extends JPanel {
    ...
    protected JLabel mTypeText;
    protected JLabel mTypeTextColor;
    protected JLabel mTypeGone;
    protected JLabel mTypeBackGround;
    ...
    public EntryHeader() {
        ...
        mTypeText = new JLabel("setText");
        mTypeText.setPreferredSize(new Dimension(100, 26));
        mTypeText.setFont(new Font(mTypeText.getFont().getFontName(), Font.BOLD, mTypeText.getFont().getSize()));



        mTypeTextColor = new JLabel("setTextColor");
        mTypeTextColor.setPreferredSize(new Dimension(100, 26));
        mTypeTextColor.setFont(new Font(mTypeTextColor.getFont().getFontName(), Font.BOLD, mTypeTextColor.getFont().getSize()));

        mTypeGone = new JLabel("setGone");
        mTypeGone.setPreferredSize(new Dimension(100, 26));
        mTypeGone.setFont(new Font(mTypeGone.getFont().getFontName(), Font.BOLD, mTypeGone.getFont().getSize()));



        mTypeBackGround = new JLabel("setBackGround");
        mTypeBackGround.setPreferredSize(new Dimension(100, 26));
        mTypeBackGround.setFont(new Font(mTypeBackGround.getFont().getFontName(), Font.BOLD, mTypeBackGround.getFont().getSize()));
